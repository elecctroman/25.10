...
$supportedLocales = $container['config']->get('locales.supported', []);
$currentLocale = $container['config']->get('locales.default', 'tr');
?><!DOCTYPE html>
<html lang="tr" data-bs-theme="light">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title><?= Security::sanitize($title ?? 'Mağaza'); ?> - <?= Security::sanitize($container['config']->get('app.name', 'Mağaza')); ?></title>
...
<header class="shadow-sm sticky-top bg-body">
    <nav class="navbar navbar-expand-lg container py-2">
        <a class="navbar-brand fw-bold" href="/"><?= Security::sanitize($container['config']->get('app.name', 'Dijital Mağaza')); ?></a>
