...
<footer class="bg-body-tertiary border-top mt-auto">
    <div class="container py-4">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled small mb-0">
                    <li><a href="mailto:<?= Security::sanitize($container['config']->get('mail.from_email', 'support@example.com')); ?>">support@example.com</a></li>
        ...
        <div class="text-center mt-3 small text-muted">© <?= date('Y'); ?> <?= Security::sanitize($container['config']->get('app.name', 'Dijital Mağaza')); ?>. Tüm hakları saklıdır.</div>
    </div>
</footer>
