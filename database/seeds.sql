...
INSERT INTO products (category_id, type, sku, name, slug, description, price, currency, tax_rate, status, created_at) VALUES
(1, 'license', 'WIN-OFFICE-2024', 'Office 2024 Pro', 'office-2024-pro', 'Dijital lisans anahtarı', 899.90, 'TRY', 18, 'active', NOW()),
(3, 'epin', 'GAME-COIN-1000', '1000 Coin Paketi', '1000-coin-paketi', 'Oyun içi para', 149.90, 'TRY', 18, 'active', NOW());
...
INSERT INTO orders (order_no, customer_id, email, total_net, total_tax, total_gross, currency, status, delivery_strategy, created_at) VALUES
('ORD20231001001', 3, 'musteri@example.com', 899.90, 161.98, 1061.88, 'TRY', 'delivered', 'auto_key', DATE_SUB(NOW(), INTERVAL 2 DAY));
